...
C_DEPS += \
./src/sam/utils/cmsis/sam3s/source/templates/gcc/startup_sam3s.d 


# Each subdirectory must supply rules for building sources it contributes
src/sam/utils/cmsis/sam3s/source/templates/gcc/%.o: ../src/sam/utils/cmsis/sam3s/source/templates/gcc/%.c
	@echo 'Building file: $<'
